...
![](analysis_cam_dat_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
## 
## data:  cont.table[1, ]
## X-squared = 18.753, df = NA, p-value = 0.04298
```
...
## 
## data:  cont.table[2, ]
## X-squared = 22.839, df = NA, p-value = 0.01399
```
...
## 
## data:  cont.table
## X-squared = 10.813, df = NA, p-value = 0.5952
```
...
![](analysis_cam_dat_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
